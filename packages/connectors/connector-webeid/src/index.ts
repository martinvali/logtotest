...
import {authorizationEndpoint } from './constant.js';
...
const createWebEIDConnector: CreateConnector<SocialConnector> = async ({ getConfig }) => {
  return {
...
export default createWebEIDConnector;
